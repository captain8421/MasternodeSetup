...
COIN_TGZP='https://github.com/sappcoin-com/SAPP/releases/download/v1.3.3/SAPP-1.3.3-Linux.zip'
COIN_BOOTSTRAP='http://sappexplorer.com/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='sapphire'
COIN_NAME_OLD='sapphired'
...
purgeOldInstallation() {
	...
	systemctl stop $COIN_NAME_OLD.service &
...
function create_config() {
  ...
  cd $CONFIGFOLDER
  wget $COIN_BOOTSTRAP
  unzip $COIN_BOOTSTRAP_NAME
  rm -r $COIN_BOOTSTRAP_NAME
  cd ~
...
cat << EOF > /root/sapp-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sapp-general-info

cat << EOF > /root/sapp-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sapp-fee-info

cat << EOF > /root/sapp-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sapp-networkinfo

cat << EOF > /root/sapp-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sapp-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/sappinfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias sappinfo='/root/sapp-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/sapp-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/sapp-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/sapp-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}sappinfo${NC}, ${RED}feestats${NC}, ${RED}networkstats${NC} and ${RED}mnstats${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
