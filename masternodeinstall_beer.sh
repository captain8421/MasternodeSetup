...
COIN_TGZP='https://github.com/sappcoin-com/SAPP/releases/download/v1.4.0.0/SAPP-1.4.0.0-Linux.zip'
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sap-general-info

cat << EOF > /root/sap-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sap-fee-info

cat << EOF > /root/sap-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sap-networkinfo

cat << EOF > /root/sap-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sap-masternode-stats
...
echo -e "alias sapinfo='/root/sap-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/sap-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/sap-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/sap-masternode-stats'" >> /root/.bashrc
exec bash
}
